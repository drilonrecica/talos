...
{:else}
  <div class="settings-grid">
    <section class="card" aria-labelledby="collection-settings">
      <h2 id="collection-settings">Collection</h2>
      {#each ['collection.host_interval', 'collection.container_interval'] as key}
        ...
        />
        <small>{setting.source} · Applies live</small>
    ...
    <section class="card" aria-labelledby="retention-settings">
      <h2 id="retention-settings">Retention &amp; storage</h2>
      ...
      <small>{snapshot.values['retention.preset'].source} · Applies live</small>
      <details>
    ...
    <section class="card" aria-labelledby="authentication-settings">
      <h2 id="authentication-settings">Authentication</h2>
    ...
    <section class="card" aria-labelledby="appearance-settings">
    ...
    <section class="card" aria-labelledby="privacy-settings">
      <h2 id="privacy-settings">Privacy &amp; network</h2>
    ...
    <section class="card" aria-labelledby="system-settings">
      <h2 id="system-settings">System</h2>
      <p><a href="/settings/monitor-health">Monitor health</a></p>
      <p><a href="/settings/diagnostics">Diagnostics bundle</a></p>
      <p>
        Data directory: <code>{snapshot.values['paths.data_dir'].value}</code> · {snapshot
          .values['paths.data_dir'].source} · Restart required
      </p>
    </section>
  </div>
  <section aria-labelledby="history-management">
